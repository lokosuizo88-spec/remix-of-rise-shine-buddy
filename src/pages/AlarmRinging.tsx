...
import { DIFFICULTY_CONFIG, BURLESQUE_MESSAGES, ChallengeType } from '@/types/alarm';
...
const AlarmRinging = () => {
  ...
  const { alarmState, alarms, dismissAlarm } = useAlarms();
  ...
  // Prevent closing - show burlesque message
  useEffect(() => {
  ...
  const handleComplete = useCallback(() => {
    ...
    if (next >= totalNeeded) {
      ...
      setKey(k => k + 1);
      // Pick new challenge type for variety
  ...
  const burlesqueMsg = alarmState.escapedCount > 0
    ...
    <div className="min-h-screen flex flex-col bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="text-center pt-8 pb-4 px-6">
          ...
          {burlesqueMsg && (
            <div className="mt-3 bg-destructive/20 border border-destructive/40 rounded-xl p-3 mx-4">
